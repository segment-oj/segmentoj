...
class GenCaptchaTest(TestCase):
    ...
    def testY_get_random_char(self):
        for i in range(1, 1000):
            random_char = self.captcha.get_random_char()
    ...
    def testX_check_similarity_false_far(self):
        ...
        self.assertFalse(self.captcha.check_similarity(color1, color2))
    ...
    def testV_check_similarity_same(self):
        ...
        self.assertTrue(self.captcha.check_similarity(color, color))

    def testU_check_similarity_true(self):
        color1 = (69, 157, 245)
        color2 = (70, 158, 246)

        self.assertTrue(self.captcha.check_similarity(color1, color2))
